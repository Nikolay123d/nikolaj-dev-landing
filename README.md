...
This repository contains a static personal landing page for Nikolaj's commercial web development services. The site is built to explain what Nikolaj sells, show proof through PráceHub.cz and ARGUS, and collect project requests through a safe email fallback.
...
- **Cafe / Restaurant Landing**, **Construction / Renovation Landing**, **Delivery / Local Service** — demo concepts, not real client projects.
...
V1 is ready for Nikolaj review.
